...
import mainLogo from "../../assets/images/Designer.png";
        ...
        <div className="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          ...
          <div>
            ...
            <a href="jajvascript:void(0);" class="text-blue-600 font-semibold text-sm hover:underline">
              ...
              <p className="my-8 text-xs text-gray-400 items-center text-center">to skip the authentication use email <span className="text-lime-500 font-bold">akash@gmail.com</span><br/> and password as <span className="text-lime-500 font-bold">password</span></p>
          ...
          <div className="md:h-auto max-md:mt-18 bg-[#000842] rounded-xl lg:p-5 p-8">
            <img src={mainLogo} className=" object-contain rounded-lg" alt="" />
          </div>
        </div>
      </div>
      <ToastContainer />
...
//       </form>
//     </div>
//     <div class="md:h-full max-md:mt-10 bg-[#000842] rounded-xl lg:p-5 p-8">
//       <img src={mainLogo} class=" object-contain rounded-lg" alt="login-image" />
//     </div>
//   </div>
// </div>
// </div>
